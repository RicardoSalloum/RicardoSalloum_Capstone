...
--- REVIEW: KEY FACTS Q&A ---

Q: What are the three pillars of a sustainable food system?
A: The three pillars are environmental health, economic viability, and social equity.

Q: How many essential amino acids must humans obtain through diet?
A: There are 9 essential amino acids that the body cannot synthesize and must get from food.

Q: What is the body's primary and preferred energy source?
A: Carbohydrates are the body's primary and preferred energy source, broken down into glucose.

Q: What do dietary fibres primarily feed?
A: Dietary fibres primarily feed gut microbiota, supporting digestion and bowel regulation.

Q: Which vitamins require fat for absorption?
A: Fat-soluble vitamins A, D, E, and K all require dietary fat to be absorbed properly.

Q: What is monoculture and why is it a problem?
A: Monoculture means growing a single crop repeatedly on the same land. It degrades soil,
reduces biodiversity, and raises vulnerability to pests and disease.

Q: Name two farming strategies that restore soil nutrients and support biodiversity.
A: Crop rotation and intercropping are both proven strategies that restore nutrients and
support agricultural biodiversity.

Q: What are the four pillars of food security?
A: Availability, Access, Utilization, and Stability. Together they define whether people
can reliably obtain and use nutritious food.

Q: How many people globally face hunger, and what drives it?
A: Approximately 733 million people face hunger. The primary drivers are poverty, conflict,
climate change, and inequality — not a global shortage of food production.

Q: Which bacteria fix nitrogen in symbiosis with legume roots?
A: Rhizobium bacteria form symbiotic relationships with legume roots to fix atmospheric nitrogen.

Q: What industrial process produces synthetic nitrogen fertilizers?
A: The Haber-Bosch process converts atmospheric nitrogen into ammonia for synthetic fertilizers.

Q: What environmental problem does excess nitrogen runoff cause?
A: Excess nitrogen runoff into waterways causes eutrophication — algal blooms that deplete
oxygen and kill aquatic life.

Q: What does the NOVA classification system measure?
A: NOVA classifies foods by the extent and purpose of their processing, not by nutrient content.

Q: Which NOVA group are ultra-processed foods?
A: Ultra-processed foods belong to NOVA Group 4.

Q: Which NOVA group contains unprocessed or minimally processed foods?
A: Unprocessed or minimally processed foods belong to NOVA Group 1.

Q: What health conditions are strongly linked to high Group 4 food consumption?
A: Obesity, type 2 diabetes, and cardiovascular disease are all strongly associated with
high consumption of ultra-processed (Group 4) foods.

Q: What share of global greenhouse gas emissions does the food system produce?
A: The food system accounts for approximately 26 to 34 percent of total global greenhouse
gas emissions.

Q: What is the single largest source of emissions within the food sector?
A: Livestock farming is the single largest contributor, responsible for roughly 14.5 percent
of global emissions, mainly through methane from enteric fermentation and nitrous oxide from manure.

Q: Which food type has the highest carbon footprint per kilogram of protein?
A: Beef has the highest carbon footprint per kilogram of protein of any food type.

Q: What share of global emissions comes from food loss and waste?
A: Food loss and waste account for around 8 to 10 percent of global greenhouse gas emissions.

Q: What dietary shift most reduces individual food-related emissions?
A: Shifting consumption toward legumes, whole grains, fruits, and vegetables is considered
one of the most impactful individual actions for reducing food-related emissions.
